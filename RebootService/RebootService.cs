...
namespace RebootService
{
    public partial class RebootService : ServiceBase
    {
        ...
        {
            /*
            string root = "HKEY_LOCAL_MACHINE\\Software\\RebootService Reboot\\";
    ...
    abstract class Parser
    {
        ...
        public virtual void execute()
        {
            foreach (string strChunk in lChunk)
            {
                ...
                */
                ...
                {
                    RebootService.writeLog("Failed to open " + strChunk + ": " + e.Message);
                    RebootService.exit(2);
        ...
        {
            RebootService.writeLog(strIn + "Command not found, check configuration file formatting or check if specific command has been implemented.");
        }
    }
    ...
    class RebootParser : Parser
    {
        ...
        public void run()
        {
            ...
            RebootService.writeLog("Now rebooting...");
            execute();
        }
    ...
    abstract class InfoParserChain : Parser
    {
        ...
        public void stringParse()
        {
            ...
            catch (Exception e)
            {
                ...
                RebootService.writeLog("Something wrong with the conf file: " + e.Message);
                RebootService.exit(1);
            }
        ...
        {
            RebootService.writeLog(strIn + "Invalid data");
        }
    }
    ...
    class SqlParserChain : InfoParserChain
    {
        ...
        public void stringParse()
        {
            ...
            catch (Exception e)
            {
                ...
                RebootService.writeLog("Conf file error: " + e);
                RebootService.writeLog("SQL data error");
                RebootService.exit(1);
            }
        ...
        public override void chainEnd()
        {
            RebootService.writeLog(strIn + "SQL connection data is invalid, check configuration file formatting or check if specific data piece is needed to connect to your SQL connection.");
        }
    }
    ...
    class Toolbox
    {
        ...
        public void connectSql()
        {
            ...
            RebootService.writeLog("Attempting to connect to SQL");
            ...
            {
                connect.Open();
                RebootService.writeLog("Connection to SQL success");
            }
            catch (Exception e)
            {
                RebootService.writeLog("Connection to SQL failed: " + e.Message);
                //RebootService.exit(2);
            }
        ...
        public void updateLastCheckin()
        {
            ...
            {
                RebootService.writeLog("Something went wrong with updating last check in date: " + e.Message);
                RebootService.exit(4);
            }
        ...
        */
        ...
        public bool checkSql()
        {
            ...
            {
                RebootService.writeLog("Conf File error: " + e.Message);
                RebootService.writeLog("SQL data error");
                RebootService.exit(1);
                return false;
            }
        ...
        {
            StreamWriter sw = new StreamWriter(RebootService.postUrl, false, System.Text.Encoding.Unicode);
        ...
        public void uploadCsv()
        {
            ...
            if (!checkConnection())
            {
                ...
                File.Move(RebootService.postUrl, postStamp);
                RebootService.writeLog("Can not upload to SQL yet, Post has been queued");
            }
            else
            {
                //Upload CSV to SQL
                readCsvForUpload();
                File.Move(RebootService.postUrl, postStamp);
                RebootService.writeLog("Post has been uploaded");
            }
        }
        ...
        public void readCsvForUpload()
        {
            ...
            DateTime lastModified = File.GetLastWriteTime(RebootService.postUrl);
            StreamReader sr = new StreamReader(RebootService.postUrl, System.Text.Encoding.Unicode);
        ...
        public void csvSqlInsert(List<string> query)
        {
            ...
            {
                RebootService.writeLog("SQL query went wrong when writing to CSV sql: " + e.Message);
                RebootService.exit(4);
            }
        ...
        public void checkPostQueue()
        {
            ...
            if (files.Length > 0)
            {
                ...
                foreach (string file in files)
                {
                    ...
                    RebootService.writeLog("Uploaded old log: " + Path.GetFileName(file));
        ...
        public void checkCsv()
        {
            ...
            StreamReader sr;
            string subject;
            sr = new StreamReader(RebootService.postUrl, System.Text.Encoding.Unicode);
            ...
            while (subject != null)
            {
                ...
                if (!String.IsNullOrEmpty(subject))
                {
                    ...
                    {
                        RebootService.writeLog("Error in the CSV file");
                        RebootService.exit(3);
                    }
                }
            }
            sr.Close();
        ...
        public void updateConfInSql(ConfStore input)
        {
            ...
            DateTime uploadDate = File.GetLastWriteTime(RebootService.confUrl);
            ...
            {
                RebootService.writeLog("Something is wrong with conf file/conf file parsing");
                RebootService.exit(1);
            }
            else
            {
        ...
        public void writeConfLinetoSql(List<string> input)
        {
            ...
            {
                RebootService.writeLog("Something went wrong when writing to Conf SQL: " + e.Message);
                RebootService.exit(4);
            }
        }
    ...
    class ConfStore
    {
        ...
        {
            //This will create a log if it doesn't exist
            StreamWriter sw = new StreamWriter(RebootService.confUrl, false);
            ...
            else
            {
                ...
                RebootService.writeLog("Could not update new Conf file");
                RebootService.exit(1);
            }
